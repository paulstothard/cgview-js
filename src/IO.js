...
class IO {
  ...
  getSVG() {
    ...
    try {
      ...
      // Restore original layers and settings before resuming any progressive
      // canvas work. Exporting a large map can otherwise leave the live view
      // showing only the strands or slots that happened to finish first.
      canvas._layers = origLayers;
      viewer.debug = debug;
